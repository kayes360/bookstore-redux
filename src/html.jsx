    ...
    <div class="container flex items-center justify-between">
      ...
      <form class="flex items-center">
        <div class="group relative rounded-md bg-white">
          ...
          <input type="text" placeholder="Filter books..." class="search" id="searchBook" />
        </div>
      </form>
    </div>
  </nav>
      ...
      <div class="order-2 xl:-order-1">
        <div class="flex items-center justify-between mb-12">
          ...
          <div class="flex items-center space-x-4">
            <button class="filter-btn active-filter" id="filterAll">All</button>
            <button class="filter-btn" id="filterFeatured">Featured</button>
          </div>
        </div>
        <div class="bookContainer">
          <!-- Card 1 -->
          <div class="book-card">
            <img class="h-[240px] w-[170px] object-cover bookThumbnail"
            ...
            <div class="flex-1 h-full pr-2 pt-2 flex flex-col">
              <div class="flex items-center justify-between">
                <span class="badge-success Badge">featured</span>
              ...
              <div class="space-y-2 mt-4 h-full">
                <h4 class="bookName">Life Hurts: A Doctor's Personal Journey Through Anorexia</h4>
                <p class="author">Dr Elizabeth McNaught</p>
                <div class="stars">
